...
{
	[TestClass]
    public class GetAllQuestionPropositionRepositoryTests
    {
        [TestMethod]
        public void AddThreeQuestionPropositionReturnsCorrectNumberOfQuestionProposition()
        {
            ...
            using (var memoryContext = new EvaluationContext(options))
            {
				...
				// ACT
				var result = questionPropositionRepository.GetAll();
