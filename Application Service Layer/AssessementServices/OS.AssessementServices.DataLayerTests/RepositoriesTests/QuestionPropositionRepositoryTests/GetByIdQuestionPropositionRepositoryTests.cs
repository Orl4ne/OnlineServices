...
{
	[TestClass]
	public class GetByIdQuestionPropositionRepositoryTests
	{
		[TestMethod]
		public void GetQuestionPropositionByIdAdddNewQuestionPropositionThenRetrieveItIsNotNull()
		{
			...
			using (var memoryContext = new EvaluationContext(options))
			{
				...
				// Act
				var result = questionPropositionRepository.GetById(questionPropositionAdded1.Id);
