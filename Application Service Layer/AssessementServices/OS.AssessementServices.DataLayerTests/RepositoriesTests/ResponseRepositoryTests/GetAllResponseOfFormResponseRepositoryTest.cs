...
{
    [TestClass]
    public class GetAllResponseOfFormResponseRepositoryTest
    {
        [TestMethod]
        public void GetAllResponseOfFormWithAttendeeIdAndSessionId()
        {
            ...
            using (var memoryContext = new EvaluationContext(options))
            {
                ...
                // Act
                var result = responseRepository.GetAllOfForm(responseAdded1.Question.FormId);
                var count = responseRepository.GetAll().Count();
