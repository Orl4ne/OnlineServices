...
namespace OS.AssessementServices.DataLayerTests.RepositoriesTests.QuestionRepositoryTest
{
	...
	{
		[TestMethod]
		public void AddNewQuestionThenRemoveItReturnsTrue()
		{
			...
			using (var memoryContext = new EvaluationContext(options))
			{
				...
				// Act
				var result1 = questionRepository.Remove(questionAdded1);
				var result2 = questionRepository.Remove(questionAdded2.Id);
				memoryContext.SaveChanges();
